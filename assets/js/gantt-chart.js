 ...
 * @version 2.0
 *
 * @edited by Will Hennessy
 * Revision:  added text to rectangles
 * Date:  April 26, 2014
 */
...
d3.gantt = function() {
    ...
    /** Add a rectangle for every item in the list **/
     chart.append("rect")
     .attr("rx", 5)
         .attr("ry", 5)
     ...
     .attr("fill", "white")
     .attr("x", function(d) {
        var middleX = (x(d.endDate) + x(d.startDate)) / 2;
        return middleX;
      })
     .attr("y", function(d) {
        var middleY = y(d.taskName) + y.rangeBand()/2;
        return middleY;
      })
